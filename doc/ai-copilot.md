...
改价/反标定）、1 条分析链（全面分析）、15 条**知识 FAQ**。其中 8 条经专业资料充实，
数字事实均有出处（ISO 2768 公差表、Protolabs/Xometry 设计规则、公制底孔表、
MIL-A-8625 阳极氧化、钛/不锈钢加工特性、Hubs 降本设计、Ra 等级），
逐条溯源见 [skill-knowledge-sources.md](skill-knowledge-sources.md)。
